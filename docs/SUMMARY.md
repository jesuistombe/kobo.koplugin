...
- [Investigations](./dev/investigations/index.md)
  - [Bluetooth Control](./dev/investigations/bluetooth/00-overview.md)
    ...
    - [Libra 2](./dev/investigations/bluetooth/libra-2/00-overview.md)
      ...
      - [Discovery](./dev/investigations/bluetooth/libra-2/02-operations.md)
      - [Connecting/Disconnecting](./dev/investigations/bluetooth/libra-2/03-shutdown.md)
      - [Connected Device Info](./dev/investigations/bluetooth/libra-2/04-input-device-mapping.md)
      - [D-Bus Examples](./dev/investigations/bluetooth/libra-2/05-known-issues.md)
