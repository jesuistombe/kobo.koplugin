...
This section documents the technical investigation and implementation details for Bluetooth control on different Kobo device types.
...
The plugin maintains full backwards compatibility while extending support to additional device types.